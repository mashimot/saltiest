...
describe('SumBeEqualsToDirective', () => {
  ...
  it('should sum be valid (single line)', () => {
    ...
    const SumBeEqualsToValidator = directive.validate(new FormControl(['12'].join('\n')));
  ...
  it('should sum be valid (multiple lines)', () => {
    const directive = new SumBeEqualsToDirective();
    directive.sumBeEqualsTo = 12;
    const SumBeEqualsToValidator = directive.validate(new FormControl(['12', ' 5 7  ', '4 4 4  '].join('\n')));
  ...
  it('should sum be invalid (multiple lines)', () => {
    const directive = new SumBeEqualsToDirective();
    directive.sumBeEqualsTo = 12;
    const SumBeEqualsToValidator = directive.validate(new FormControl(['12', ' 5 5  ', '4 4 4  '].join('\n')));
