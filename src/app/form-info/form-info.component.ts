...
export class FormInfoComponent implements OnInit {
    ...
    getPagesRowsColumnsContents(indexPages: number, indexRows: number, indexColumns: number): FormArray {
        return (((this.form.get('pages') as FormArray).at(indexPages).get('rows') as FormArray).at(indexRows).get('columns') as FormArray).at(indexColumns).get('contents') as FormArray;
    }

    getPagesRowsColumnsContentsChoices(indexPages: number, indexRows: number, indexColumns: number, indexContents: number): FormArray {
        return ((((this.form.get('pages') as FormArray).at(indexPages).get('rows') as FormArray).at(indexRows).get('columns') as FormArray).at(indexColumns).get('contents') as FormArray).at(indexContents) as FormArray;
    }    

    deletePagesRowsColumnsContents(indexPages: number, indexRows: number, indexColumns: number, indexContents: number): void {
    ...
    getPagesRowsColumns(indexPages: number, indexRows: number): FormArray {
        return ((this.form.get('pages') as FormArray).at(indexPages).get('rows') as FormArray).at(indexRows).get('columns') as FormArray;
    }
