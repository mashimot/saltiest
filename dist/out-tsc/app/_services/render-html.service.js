...
var BootstrapForm = /** @class */ (function () {
    ...
    BootstrapForm.prototype.get = function () {
        ...
        var data = {
            ...
            "textarea": ["<div class=\"form-group\" id=\"div_" + this.table.column_name + "\">",
                ...
                "</div>"],
            "select": ["<div class=\"form-group\" id=\"div_" + this.table.column_name + "\">",
                ...
                "</select>",
                "</div>"],
            "checkbox": ["<div class=\"form-group\" id=\"div_" + this.table.column_name + "\">",
                "<label for=\"i_" + this.table.column_name + "\">" + this.html.label + "</label>",
                "" + this.html.choices.map(function (element) { return "<div class=\"checkbox\"><label><input type=\"checkbox\" name=\"" + _this.table.column_name + "\" value=\"" + element.value + "\"> " + element.text + "</label></div>"; }).join(''),
                "</div>"],
            "radio": ["<div class=\"form-group\" id=\"div_" + this.table.column_name + "\">",
                "<label for=\"i_" + this.table.column_name + "\">" + this.html.label + "</label>",
                "" + this.html.choices.map(function (element) { return "<div class=\"radio\"><label><input type=\"radio\" name=\"" + _this.table.column_name + "\" value=\"" + element.value + "\"> " + element.text + "</label></div>"; }).join(''),
                "</div>"],
            "text": ["<div class=\"form-group\" id=\"div_" + this.table.column_name + "\">",
                "<label for=\"i_" + this.table.column_name + "\">" + this.html.label + "</label>",
                ...
                "</div>"],
            "number": ["<div class=\"form-group\" id=\"div_" + this.table.column_name + "\">",
                "<label for=\"i_" + this.table.column_name + "\">" + this.html.label + "</label>",
                ...
                "</div>"],
            "date": ["<div class=\"form-group\" id=\"div_" + this.table.column_name + "\">",
                "<label for=\"i_" + this.table.column_name + "\">" + this.html.label + "</label>",
    ...
    CustomForm.prototype.get = function () {
        ...
        var data = {
            ...
            "table": ["<table class=\"table\">",
                ...
                "</table>"],
            "image": ["<img src=\"" + this.html.src + "\" class=\"img-fluid\">"],
            "textarea": ["{!! $HTML::textArea(" + this.html.grid + ", '" + this.table.column_name + "', " + (parseInt(this.table.size) > 0 ? "" + this.table.size : "''") + ", \"" + this.html.label + "\", " + (this.table.nullable ? "true" : "false") + ", true, true, '', '" + this.table.column_name + "') !!}"],
            "select": ["{!! $HTML::selectDominio(" + this.html.grid + ", '" + this.table.column_name + "', '" + this.html.label + "', " + (this.table.nullable ? "true" : "false") + ", true, true, '', '" + this.table.column_name + "' ) !!}"],
            "checkbox": ["<div class=\"form-group\" id=\"div_" + this.table.column_name + "\">",
                "<label for=\"i_" + this.table.column_name + "\">" + this.html.label + "</label>",
                "" + this.html.choices.map(function (element) { return "<div class=\"checkbox\"><label><input type=\"checkbox\" name=\"" + _this.table.column_name + "\" value=\"" + element.value + "\"> " + element.text + "</label></div>"; }).join(''),
                "</div>"],
            "radio": ["<div class=\"form-group\" id=\"div_" + this.table.column_name + "\">",
                ...
                "" + this.html.choices.map(function (element) { return "<div class=\"radio\"><label><input type=\"radio\" name=\"" + _this.table.column_name + "\" value=\"" + element.value + "\"> " + element.text + "</label></div>"; }).join(''),
                "</div>"],
            "text": ["{!! $HTML::inputTexto(" + this.html.grid + ", '" + this.table.column_name + "', " + (parseInt(this.table.size) > 0 ? "" + this.table.size : "''") + ", '" + this.html.label + "', " + (this.table.nullable ? "true" : "false") + ", true, true, '', '" + this.table.column_name + "') !!}"],
            "number": ["{!! $HTML::inputNumero(" + this.html.grid + ", '" + (this.table.size ? (this.table.size.indexOf('.') != -1 ? "decimal" : "inteiro") : '') + "', '" + this.table.column_name + "', " + (parseInt(this.table.size) > 0 ? "" + this.table.size : "''") + ", '" + this.html.label + "', " + (this.table.nullable ? "true" : "false") + ", true, true, '', '" + this.table.column_name + "') !!}"],
            "date": ["{!! $HTML::inputData(" + this.html.grid + ", '" + this.table.column_name + "', '" + this.html.label + "', " + (this.table.nullable ? "true" : "false") + ", true, true, '', '" + this.table.column_name + "') !!}"]
        };
        return typeof data[this.html.tag] !== 'undefined' ? data[this.html.tag].join("\n") : '';
    };
    return CustomForm;
